...
export default function MatchWithOthers() {
	...
	return (
		<section className="py-[100px] xl:pt-[210px] xl:pb-[125px] max-xl:pb-0">
			<div className="container">
				...
				<div
					className={cn(
						"relative scale-75 duration-1000 transition-all max-w-[450px] max-lg:max-w-[300px] max-sm:max-w-[223px] mx-auto",
						{
							"scale-100": isVisible,
						}
					)}
...
const ExploreBestFitCard = ({
	...
	return (
		<>
			<div
				className="how-it-works-card shadow-none h-auto p-0 bg-transparent relative mx-auto max-w-[377px] duration-1000 transition-all !delay-0"
				style={{
					transform:
						currentIndex > index
							? "translate(-80px, 80px) rotate(-15deg)"
							: currentIndex == index
							? ""
							: "translate(80px, 80px) rotate(15deg)",
				}}
			>
				<img
					...
					alt=""
				/>
				<div className="bg-white p-3 card-content-shadow rounded-2xl scale-0 opacity-0 group-[.swiper-slide-active]:scale-100 group-[.swiper-slide-active]:opacity-100 rotate-[-5.16deg] translate-y-[-80px] sm:translate-y-[-100px] translate-x-[calc(50%-0px)] max-w-[182px] sm:max-w-[291px] duration-1000 delay-300 transition-all">
				...
				<div className="w-[108px] py-4 scale-0 opacity-0 group-[.swiper-slide-active]:scale-75 sm:group-[.swiper-slide-active]:scale-100 group-[.swiper-slide-active]:opacity-100 duration-1000 delay-300 transition-all absolute top-12 xl:top-[75px] left-[-50px] z-10  bg-[#9379EC] rounded-[20px]">
					<div className="flex flex-col gap-3 text-center items-center duration-0">
